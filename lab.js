...
const myFirstVehicle = new Vehicle(5, 'green', 193000);
...
const myFirstMotorcycle = new Motorcycle(2, 'lime green', 100, 'kawasaki', true);
...
const myFirstBoat = new Boat(8, 'yellow', 8000, 'Water Skipper', 'speed boat', false);
